...
describe RecipesController do
  ...
  let(:valid_attributes) { { "directions" => "MyText" } }
  ...
  before(:each) do
    @recipe = FactoryGirl.create(:recipe, :with_ingredients)
    login_with_oauth
  end
  ...
  #       post :create, {:recipe => { "directions" => "invalid value" }}, valid_session
  #       assigns(:recipe).should be_a_new(Recipe)
  #     end
  ...
  #       Recipe.any_instance.should_receive(:update).with({ "directions" => "MyText" })
  #       put :update, {:id => recipe.to_param, :recipe => { "directions" => "MyText" }}, valid_session
  #     end
  ...
  #       # Trigger the behavior that occurs when invalid params are submitted
  #       Recipe.any_instance.stub(:save).and_return(false)
  #       put :update, {:id => recipe.to_param, :recipe => { "directions" => "invalid value" }}, valid_session
  #       assigns(:recipe).should eq(recipe)
  #     end
